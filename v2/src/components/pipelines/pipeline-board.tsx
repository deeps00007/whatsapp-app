...
function StageColumn({
  ...
  return (
    ...
    <div className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl border border-border bg-background/60 p-4 lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      ...
      <div className="flex items-center justify-between pt-3">
        ...
        <span className="shrink-0 rounded-full bg-card px-2 py-0.5 text-[11px] font-medium text-foreground">
          {deals.length}
        </span>
      </div>
      ...
      <Button
        ...
        className="mt-3 w-full justify-start border border-dashed border-border bg-transparent text-muted-foreground hover:border-border hover:bg-accent hover:text-foreground"
      >
