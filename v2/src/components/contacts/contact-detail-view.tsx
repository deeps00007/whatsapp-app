          ...
          <div className="flex flex-col h-full">
            ...
            <SheetHeader className="p-4 border-b border-border/50">
              <div className="flex items-center gap-3">
                <Avatar className="size-12 bg-card border border-border">
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-accent/50 border-b border-border mx-4 mt-3">
                <TabsTrigger
                  value="details"
                ...
                <div className="flex-1 overflow-y-auto space-y-2">
                  {loadingNotes ? (
                    ...
                    notes.map((note) => (
                      <div
                        key={note.id}
                        className="rounded-lg bg-accent/50 border border-border/50 p-3 group"
                      >
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="bg-card border-border text-foreground h-8 text-sm placeholder:text-muted-foreground"
                        />
                      </div>
                    ))}
                    <Button
