  ...
  return (
    <div className="space-y-6">
            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-border bg-background p-4 text-left transition-colors hover:border-primary/50 hover:bg-background/80"
                >
      ...
      {automations.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-border bg-background/40">
...
function AutomationCard({
  ...
  return (
    <li className="rounded-xl border border-border bg-background transition-colors hover:border-border">
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-foreground data-[popup-open]:bg-card"
            >
